...
{
    pv52.header = header;
    pv52.increase_sort_description_compile_attempts = increase_sort_description_compile_attempts;
    pv52.max_bytes_before_external_sort = max_bytes_before_external_sort_;
    pv52.max_bytes_before_remerge = max_bytes_before_remerge_;
    pv52.remerge_lowered_memory_bytes_ratio = remerge_lowered_memory_bytes_ratio_;
    pv52.limit = limit;
    pv52.max_merged_block_size = max_merged_block_size_;
    pv52.min_free_disk_space = min_free_disk_space_;
}
